...
const getDriverJobs = async (req, res) => {
  try {
    ...
    res.status(500).json({ message: "Could not retrieve driver jobs", error: error.message });
  }
};
...
const updateStatus = async (req, res) => {
  try {
    ...
    res.status(500).json({ message: "Could not update assignment status", error: error.message });
  }
};
...
const completeAssignment = async (req, res) => {
  try {
    ...
    res.status(500).json({ message: "Could not complete assignment", error: error.message });
  }
};
...
const failAssignment = async (req, res) => {
  try {
    ...
    res.status(500).json({ message: "Could not mark assignment as failed", error: error.message });
  }
};
